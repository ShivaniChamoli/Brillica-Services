...
<body>
  ...
  <div class="container-fluid"style="background-color:#edecec; background-size: cover">
    <div class="row" style="height: 100%;" >
      ...
      <h1 class="pri-h">Terms and Conditions</h1>
      <b>Disclaimer: Please read and edit the TERMS AND CONDITIONS Policy given below as per your website’s requirement. Don’t use or apply these as is basis on your website
        <br><br><br>
        Your website may use the Terms and Conditions given below.</b>
      <br><br><br>
      ...
      <br><br>
      Visitors are prohibited from violating or attempting to violate the security of the Web site, including, without limitation,<br><br>
      (1) accessing data not intended for such user or logging into a server or account which the user is not authorised to access,<br><br>
      ...
      <br>User further agrees that Company shall not be liable for any damages arising from interruption, suspension or termination of service, including but not limited to direct or/and indirect or/and incidental or/and special consequential or/and exemplary damages, whether such interruption or/and suspension or/and termination was justified or not, negligent or intentional, inadvertent or advertent.
      <br><br>User agrees that Company shall not be responsible or liable to user, or anyone, for the statements or conduct of any third party of the service. In sum, in no event shall Company’s total liability to the User for all damages or/and losses or/and causes of action exceed the amount paid by the User to Company, if any, that is related to the cause of action.
      <br><br><br>
      <b>INDEMNITY</b>
      <br><br><br>
